...
import { getAllTransactions, createTransaction, createTransactionFromReservation, returnBook, createTransactionDetail } from "@/app/actions/transactionActions"
import { getAllReservations } from "@/app/actions/reservationActions"
import { bookCopyAPI } from "@/lib/api/bookCopyAPI"
import { Search, Users, CreditCard, BookOpen, Clock, Plus, CheckCircle, RotateCcw, AlertTriangle, X } from "lucide-react"
...
function UserManagementPage() {
    ...
    const loadAvailableBookCopies = async () => {
        ...
        try {
            ...
            if ("data" in result && result.data) {
                ...
                const availableCopies = result.data.filter(copy => 
    ...
    const handleCreatePenalty = async () => {
        ...
        try {
            ...
            setError("Failed to assess penalty")        } finally {
            setProcessingTransaction(false)
        }
    }
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {selectedUser && (
                    <div className="bg-gray-800 rounded-lg border border-gray-700">                        <div className="p-6 border-b border-gray-700">
                            <div className="flex justify-between items-center">
                                <h2 className="text-xl font-semibold flex items-center">
                                    <Users className="w-5 h-5 mr-2" />
                            ...
                            <div className="mb-8">
                                ...
                                {loading ? (
                                    ...
                                    <div className="space-y-4">
                                        {userReservations.map((reservation) => (                                            <div
                                                key={reservation.id}
