export const mockAuthors = [
  {
    ...
    imageUrl:
      "https://ui-avatars.com/api/?name=Robert+C.+Martin&background=0D8ABC&color=fff",
    bio: "Robert C. Martin, also known as 'Uncle Bob', is a renowned software engineer and author.",
    socialLinks: {
  ...
  },
  {
    ...
    name: "Kyle Simpson",
    imageUrl:
      "https://ui-avatars.com/api/?name=Kyle+Simpson&background=6C63FF&color=fff",
    bio: "Kyle Simpson is the author of the 'You Don't Know JS' series and a prominent JavaScript educator.",
    socialLinks: {
  ...
  {
    id: "A_10",
    name: "Guido van Rossum in the Streets",
    imageUrl:
  ...
  {
    id: "A_15",
    name: "Josée Lajoie's Memory Leak",
    imageUrl:
  ...
  {
    id: "A_17",
    name: "Michael C. Feathers His Nest",
    imageUrl:
